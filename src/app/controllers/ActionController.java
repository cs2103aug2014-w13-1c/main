...
public class ActionController {
    ...
    protected String update(CommandParser parsedCommand) {
        ...
        try {
            taskList.updateTask(todoList.get(index).getUUID(),
    ...
    protected String done(CommandParser parsedCommand) {
        ...
        try {
            taskList.updateTask(todoList.get(index).getUUID(), parameters, null, null, null, null, true);
        } catch (IOException e) {
            // do something here?
            LoggingService.getLogger().log(Level.SEVERE, "IOException: " + e.getMessage());
        }
    ...
    protected String undone(CommandParser parsedCommand) {
        ...
        Boolean[] parameters = {false, false, false, false, true};
        try {
            taskList.updateTask(todoList.get(index).getUUID(), parameters, null, null, null, null, false);
        } catch (IOException e) {
            // do something here?
            LoggingService.getLogger().log(Level.SEVERE, "IOException: " + e.getMessage());
        }
